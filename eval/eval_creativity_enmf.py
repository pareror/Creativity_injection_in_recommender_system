"""
Creativity Score Reranking per ENMF
====================================
Variante specifica per il modello ENMF con fix per reshape e history filtering.
...
CHECKPOINTS = [
    ...
    #'./saved/ENMF-Dec-22-2025_18-49-08.pth',  # Amazon (full, RO)
...
def custom_load_model(model_file):
    """Usa load_data_and_model di RecBole."""
...
# ==========================================
# GENERAZIONE RACCOMANDAZIONI CON SCORES (FIX ENMF)
# ==========================================

def generate_recs_with_scores(model, test_data, topk, user_history):
    """Genera top-k raccomandazioni con scores, fix per ENMF reshape e filtraggio history."""
    user_recs = {}
...
def main():
    ...
    try:
        print("=" * 80)
        print("VALUTAZIONE CREATIVITY SCORE RERANKING - ENMF")
